...
- **Known lint debt.** 41 ESLint errors remain, nearly all `@typescript-eslint/no-explicit-any` on API response shapes, plus one `react-hooks/purity` error in `CustomersPage.tsx`.
